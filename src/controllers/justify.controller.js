...
import { isUserAllowedToUseWords, recordWordUsage, } from "../services/storage.service.js";
/**
...
export const justify = (req, res) => {
    ...
    const isAllowed = isUserAllowedToUseWords(token, wordCount);
    if (!isAllowed) {
