...
describe("Justify Controller", () => {
  ...
  it("Should justify text correctly", async () => {
    const text =
      "For a long time, I went to bed early. Sometimes, my candle barely out, my eyes would close so quickly that I did not have time to say to myself: I am falling asleep.";
